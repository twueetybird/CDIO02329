...
Start_Betting_WithWheelHistory:
    ...
    ; ----------------------------------------------------------
    ; Step 1: Load new spin into R3 (will be inserted at index 0)
    ; ----------------------------------------------------------
    LD R0, WINNING_VALUE_ADDR
    LDR R3, R0, #0         ; R3 = new spin (carry value to insert)

    ; ----------------------------------------------------------
    ; Step 2: Shift values down using bucket brigade logic
    ; ----------------------------------------------------------
...
ShiftLoop:
    ...
    STR R3, R1, #0              ; store previous value (R3)
    ...
    ; ----------------------------------------------------------
    ; Step 3: Print values from index 0 ? 9
    ; ----------------------------------------------------------
...
SLOW_DOWN1	.FILL -1003
SLOW_DOWN2	.FILL -1439
SLOW_DOWN3	.FILL -2359
SLOW_DOWN4	.FILL -4123
